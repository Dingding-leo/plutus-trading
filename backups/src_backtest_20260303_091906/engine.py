...
class BacktestEngine:
    ...
    def calculate_entry_fees(self, size: float, price: float) -> float:
        ...
        return size * price * self.taker_fee
    ...
    def get_results(self) -> BacktestResult:
        ...
        for symbol, trade in list(self.open_trades.items()):
            self.close_trade(symbol, trade.entry_price, datetime.now(), "END_OF_BACKTEST")
...
class MultiCoinBacktester:
            ...
            for tf in timeframes:
                ...
                try:
                    candles = data_client.fetch_history(
                        ...
                        start_date,
                        end_date,
                        max_candles=5000  # Limit to avoid huge datasets
                    )
    ...
    def run(
        ...
        # Fetch data
        self.fetch_data(symbols, timeframes, start_date, end_date)
